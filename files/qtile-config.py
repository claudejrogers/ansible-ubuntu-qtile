...
def autostart():
    exe = f"{HOME}/.config/qtile/autostart.sh"
...
keys = [
    ...
    # Rofi Launcher
    Key([mod], "a", lazy.spawn("rofi -show drun -l 10")),
    Key([mod], "p", lazy.spawn(f"sh {HOME}/.local/scripts/powermenu.sh")),
]
...
bar_widgets = [
    ...
    widget.Battery(
        ...
        full_char="󰁹",
        foreground=Colors.GREEN.value,
        low_foreground=Colors.RED.value,
    ),
